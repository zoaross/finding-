-- Finding completion + feedback sync
-- Run this in Supabase SQL Editor.
--
-- Purpose:
-- - Chat completion stores feedback with source need/profile context.
-- - Completed conversations can be listed in /admin/feedback.
-- - Need completion remains persisted and visible in My Needs -> Archived.
